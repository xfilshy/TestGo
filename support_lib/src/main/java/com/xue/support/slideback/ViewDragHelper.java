...
import static com.xue.support.slideback.utils.DensityUtil.getScreenHeight;
import static com.xue.support.slideback.utils.SystemBarUtil.getNavigationHeight;
import static com.xue.support.slideback.utils.SystemBarUtil.hasNavigationBar;
...
public class ViewDragHelper {
    ...
    private int getEdgesTouched(int x, int y) {
        ...
        if (SDK_INT >= KITKAT && mParentView.getContext() instanceof Activity
            ...
            if (mTempRect.bottom >= getScreenHeight(activity)) {
