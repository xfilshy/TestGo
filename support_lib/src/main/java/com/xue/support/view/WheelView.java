...
import com.xue.support.bean.WheelBean;
 ...
 * @author JiangPing
 */
public class WheelView<T extends WheelBean> extends View {
    /**
     * 控件宽度
     */
        ...
        for (ItemObject item : itemList) {
            if (item.isSelected()) {
                if (onSelectListener != null)
                    onSelectListener.endSelect(item.postion, item.t);
                break;
            }
        }
    }
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itmItemObject.postion = i;
            itmItemObject.t = dataList.get(i);
            itmItemObject.x = 0;
        ...
        if (move > 0) {
            for (int i = 0; i < itemList.size(); i++) {
                if (itemList.get(i).isSelected()) {
                    ...
                    if (onSelectListener != null)
                        onSelectListener.endSelect(itemList.get(i).postion,
                                itemList.get(i).t);
                    break;
                }
            }
    ...
    private void onSelectListener() {
        ...
        for (ItemObject item : itemList) {
            if (item.isSelected()) {
                onSelectListener.selecting(item.postion, item.t);
            }
        }
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas, int containerWidth) {
            ...
            String itemText = (String) TextUtils.ellipsize(t.getName(), textPaint, containerWidth,
     ...
     * @author JiangPing
     */
    public interface OnSelectListener<T extends WheelBean> {
        /**
         * 结束选择
         */
        public void endSelect(int postion, T t);

        /**
         * 选中的内容
         */
        public void selecting(int postion, T t);
