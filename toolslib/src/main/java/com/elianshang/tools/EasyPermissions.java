...
public class EasyPermissions {
     ...
     */
    public static void requestPermissions(final Object object, String rationale, final int requestCode, final DialogInterface.OnClickListener negativeOnClickListener, final boolean cancelAble, final String... perms) {
        requestPermissions(object, rationale,
                android.R.string.ok,
                android.R.string.cancel,
                negativeOnClickListener,
                requestCode, cancelAble, perms);
    }
     ...
     * @param perms          a set of permissions to be requested.
     */
    public static void requestPermissions(final Object object, String rationale, @StringRes int positiveButton, @StringRes int negativeButton, final DialogInterface.OnClickListener negativeOnClickListener, final int requestCode, final boolean cancelAble, final String... perms) {
