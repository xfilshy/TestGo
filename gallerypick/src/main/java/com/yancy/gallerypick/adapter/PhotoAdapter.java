...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (selectPhoto.contains(photoInfo.path)) {
            ...
            viewHolder.chkPhotoSelector.setButtonDrawable(R.drawable.gallery_pick_select_checked);
            viewHolder.vPhotoMask.setVisibility(View.VISIBLE);
        } else {
            viewHolder.chkPhotoSelector.setChecked(false);
            viewHolder.chkPhotoSelector.setButtonDrawable(R.drawable.gallery_pick_select_unchecked);
